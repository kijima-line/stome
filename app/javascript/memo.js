...
window.onscroll = function () {
  let headerH = document.getElementsByClassName('h2')[0].clientHeight; // headerの高さを取得
  ...
  // 上で取得した高さを合計する
  let totalH = headerH;
  //+ side_authorH + side_searchH + side_categoryH;
  // 追従させたい要素のクラス名を取得する
  let side_adv = document.getElementsByClassName('h2')[0];
